...
func _update_theme() -> void:
	...
	_hints_panel.add_theme_stylebox_override("panel", hints_panel_style)
	...
	_starting_code.add_theme_font_override("font", get_font("source", "EditorFonts"))
...
func _on_get_cursor_position_button() -> void:
	_line_spinbox.value = _starting_code.get_caret_line() + 1
	_column_spinbox.value = _starting_code.get_caret_column() + 1
